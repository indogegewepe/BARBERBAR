    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- Cabang -->
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="cabang.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabel Cabang</h6>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="justify-content-center px-2 py-1">
                                                        <h6 class="mb-0 text-sm"><?php echo $cabang["nama_cabang"] ?></h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?php echo $cabang["no_hp"] ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?php echo $cabang["alamat"] ?></p>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <a class="btn btn-primary" href="editcabang.php?id=<?php echo $cabang['id_cabang'] ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-primary" href="hapuscabang.php?id=<?php echo $cabang['id_cabang'] ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        Hapus
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <td class="text-center">
                                            <buttons class="btn btn-primary text-secondary font-weight-bold text-xs text-white" data-bs-toggle="modal" data-bs-target="#TambahCabang">
                                                Tambah Cabang
                                            </buttons>
                                        </td>
                                    </tbody>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-normal" id="TambahCabangLabel">Tambah Cabang</h5>
                        </div>
                        <div class="modal-body">
                            <form class="user" method="POST" action="../config.php">
                                <div class="modal-body">
                                ...
                                <div class=" modal-footer">
                                    ...
                                    <button type="submit" class="btn bg-gradient-primary" name="insertCabang">Save changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
