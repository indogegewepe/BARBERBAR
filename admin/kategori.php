                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="justify-content-center px-2 py-1">
                                                        <h6 class="mb-0 text-sm"><?php echo $kategori["kategori"] ?></h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?php echo $kategori["harga"] ?></p>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <a class="btn btn-primary" href="editkategori.php?id=<?php echo $kategori['id_kategori'] ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-primary" href="hapuskategori.php?id=<?php echo $kategori['id_kategori'] ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        Hapus
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <td class="text-center">
                                            <buttons class="btn btn-primary text-secondary font-weight-bold text-xs text-white" data-bs-toggle="modal" data-bs-target="#TambahKategori">
                                                Tambah Kategori
                                            </buttons>
                                        </td>
                                    </tbody>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-normal" id="TambahKategoriLabel">Tambah Kategori</h5>
                        </div>
                        <div class="modal-body">
                            <form class="user" method="POST" action="../config.php">
                                ...
                                <div class=" modal-footer">
                                    ...
                                    <button type="submit" class="btn bg-gradient-primary" name="insertKategori">Save changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
